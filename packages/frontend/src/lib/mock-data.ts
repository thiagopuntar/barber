import { Calendar as CalendarIcon, User, CheckCircle2 } from "lucide-react";
...
export const COMPANIES: Record<string, Company> = {
    "appointment-premium": {
        name: "Appointment Premium",
        slug: "appointment-premium",
        ...
        services: [
            { id: 1, name: "Consultation", price: "R$ 50,00", duration: "30 min", icon: CalendarIcon },
            { id: 2, name: "General Service", price: "R$ 35,00", duration: "20 min", icon: User },
            { id: 3, name: "Complete Package", price: "R$ 80,00", duration: "50 min", icon: CheckCircle2 },
        ],
        professionals: [
            { id: 1, name: "Professional João", role: "Expert Specialist", image: "https://images.unsplash.com/photo-1599566150163-29194dcaad36?w=400&h=400&fit=crop" },
            { id: 2, name: "Professional Marcos", role: "Specialist", image: "https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=400&h=400&fit=crop" },
            { id: 3, name: "Professional Lucas", role: "Junior Associate", image: "https://images.unsplash.com/photo-1633332755192-727a05c4013d?w=400&h=400&fit=crop" },
        ],
        timeSlots: [
    ...
    "quick-appointment": {
        ...
        services: [
            { id: 1, name: "Quick Consultation", price: "R$ 30,00", duration: "15 min", icon: CalendarIcon },
            { id: 2, name: "Express Service", price: "R$ 20,00", duration: "10 min", icon: User },
        ],
        professionals: [
            { id: 4, name: "Professional Pedro", role: "Specialist", image: "https://images.unsplash.com/photo-1581092795360-fd1ca04f0952?w=400&h=400&fit=crop" },
            { id: 5, name: "Professional Tiago", role: "Specialist", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop" },
        ],
        timeSlots: [
