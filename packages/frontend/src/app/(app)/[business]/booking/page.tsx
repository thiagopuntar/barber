        ...
        <div className="container mx-auto px-4 pb-8">
          <div className="relative w-full h-64 md:h-80 rounded-3xl overflow-hidden shadow-lg">
            ...
            <div className="absolute top-4 right-4 flex gap-2">
              <Badge
                variant="secondary"
                className="bg-white/90 backdrop-blur text-teal-700 hover:bg-white font-bold gap-1 px-3 py-1.5 rounded-full"
              >
                <ShieldCheck className="h-3.5 w-3.5" /> Verificado
              </Badge>
              <Badge
                variant="secondary"
                className="bg-white/90 backdrop-blur text-green-700 hover:bg-white font-bold gap-1 px-3 py-1.5 rounded-full"
              >
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 md:p-8 shadow-sm border border-slate-100 dark:border-slate-800 relative">
            ...
            <div className="flex justify-end gap-2 mb-2">
              <Button
                size="icon"
                variant="outline"
                className="rounded-full h-10 w-10 border-slate-200 dark:border-slate-700 text-slate-400 hover:text-red-500 dark:bg-slate-800/50"
              >
              ...
              <Button
                size="icon"
                variant="outline"
                className="rounded-full h-10 w-10 border-slate-200 text-slate-400 hover:text-primary"
              >
          ...
          <div>
            ...
            <div className="flex gap-2 mb-6">
              <Badge
                variant="outline"
                className="rounded-full px-4 py-1.5 border-primary bg-primary/5 text-primary cursor-pointer hover:bg-primary/10"
              >
                Todos
              </Badge>
              <Badge
                variant="outline"
                className="rounded-full px-4 py-1.5 border-slate-200 dark:border-slate-800 text-slate-500 dark:text-slate-400 cursor-pointer hover:border-slate-300 dark:hover:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800"
              >
                Populares
              </Badge>
              <Badge
                    ...
                    <div className="flex justify-between items-start gap-4">
                      <div className="flex-1">
                        ...
                        <p className="text-slate-500 dark:text-slate-400 text-sm mb-3">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lavagem
                          inclusa.
                        </p>
          ...
          <div className="sticky top-24 space-y-6">
              ...
              {selectedServiceDetails.length > 0 ? (
                <div className="space-y-4">
                  ...
                  <p className="text-xs text-center text-slate-400">
                    Cancelamento grátis até 2 horas antes.
                  </p>
                </div>
              ) : (
            ...
            <div className="bg-emerald-100/50 rounded-3xl p-1 border border-emerald-100 overflow-hidden h-64 relative group cursor-pointer">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Button
                  variant="secondary"
                  className="bg-white text-slate-900 hover:bg-primary hover:text-white font-bold shadow-lg gap-2"
                >
