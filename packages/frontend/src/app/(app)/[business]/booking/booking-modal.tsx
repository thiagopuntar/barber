          ...
          <div className="p-6 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/50 flex justify-between items-center">
            {step > 1 ? (
              <Button
                ...
                className="font-bold text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200"
              >
                Voltar
              </Button>
            ) : (
            ...
            <Button
              ...
              disabled={
                (step === 1 && (!selectedTime || selectedDate === null)) ||
            ...
            >
              {step === 1 ? "Continuar" : "Confirmar e Agendar"}{" "}
