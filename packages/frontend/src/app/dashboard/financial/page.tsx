  ...
  return (
    <div className="space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-border pb-6">
        ...
        <Button
          variant="outline"
          className="bg-transparent text-muted-foreground border-border hover:bg-muted hover:text-foreground uppercase tracking-wider h-10 px-6 rounded-sm text-xs font-bold"
        >
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <Card className="bg-card dark:bg-zinc-900/50 border-border dark:border-zinc-800 backdrop-blur-sm">
          ...
          <CardContent>
            ...
            <p className="text-[10px] uppercase tracking-widest text-muted-foreground dark:text-zinc-300 mt-2">
              Mês Atual
            </p>
          </CardContent>
        </Card>
      ...
      <Card className="bg-card dark:bg-zinc-900/50 border-border dark:border-zinc-800 backdrop-blur-sm min-h-[400px]">
        <CardHeader>
          <CardTitle className="text-foreground dark:text-white text-lg uppercase tracking-wide">
            Fluxo de Caixa
          </CardTitle>
          <CardDescription className="text-muted-foreground dark:text-zinc-300 text-xs uppercase tracking-wider">
            Entradas e saídas dos últimos 30 dias
          </CardDescription>
        </CardHeader>
