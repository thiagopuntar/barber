            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                ...
                <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm hover:border-zinc-700 transition-colors group">
                    <CardHeader>
                        ...
                        <CardDescription className="text-zinc-500 text-xs uppercase tracking-wider">Clássico ou Moderno</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center justify-between border-t border-zinc-800 pt-4 mt-2">
                            ...
                            <div className="px-2 py-1 bg-zinc-800 rounded-sm text-[10px] uppercase font-bold text-zinc-400 tracking-wider">
                                30 min
                            </div>
                        </div>
                    </CardContent>
                ...
                <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm hover:border-zinc-700 transition-colors group">
                    <CardHeader>
                        ...
                        <CardDescription className="text-zinc-500 text-xs uppercase tracking-wider">Modelagem e Hidratação</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center justify-between border-t border-zinc-800 pt-4 mt-2">
                ...
                <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm hover:border-zinc-700 transition-colors group">
                    <CardHeader>
                        ...
                        <CardDescription className="text-zinc-500 text-xs uppercase tracking-wider">Cabelo + Barba + Sobrancelha</CardDescription>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center justify-between border-t border-zinc-800 pt-4 mt-2">
