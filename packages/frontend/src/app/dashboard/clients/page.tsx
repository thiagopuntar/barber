        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border dark:border-zinc-800 bg-muted/50 dark:bg-zinc-900/80">
              <th className="h-12 px-4 text-left font-bold text-muted-foreground uppercase tracking-widest text-[10px]">
                Nome
              </th>
              <th className="h-12 px-4 text-left font-bold text-muted-foreground uppercase tracking-widest text-[10px]">
                Email
              ...
              <th className="h-12 px-4 text-right font-bold text-muted-foreground uppercase tracking-widest text-[10px]">
                Ações
              </th>
            </tr>
          </thead>
          <tbody>
            {[1, 2, 3, 4, 5].map(i => (
              <tr
                key={i}
                className="border-b border-border dark:border-zinc-800/50 hover:bg-muted/50 dark:hover:bg-zinc-800/30 transition-colors"
              >
                ...
                <td className="p-4 text-right">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-8 w-8 text-muted-foreground hover:text-foreground hover:bg-muted dark:hover:bg-zinc-800 rounded-sm"
                  >
