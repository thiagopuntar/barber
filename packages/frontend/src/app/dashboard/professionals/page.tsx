    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
        {[1, 2, 3, 4].map(i => (
          <Card
            key={i}
            className="bg-card dark:bg-zinc-900/50 border-border dark:border-zinc-800 backdrop-blur-sm hover:border-zinc-400 dark:hover:border-zinc-700 transition-all group overflow-hidden"
          >
            <div className="aspect-square relative w-full bg-muted dark:bg-zinc-950">
              ...
              <div className="absolute bottom-4 left-4 z-10">
                <h3 className="text-white font-bold uppercase tracking-wide text-lg">
                  Profissional {i}
                </h3>
                <p className="text-blue-500 text-xs uppercase tracking-widest font-medium">
                  Especialista
                </p>
              </div>
            </div>
