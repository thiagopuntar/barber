        ...
        <div className="space-y-8">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                {[1, 2, 3, 4].map((i) => (
                    ...
                    <Card key={i} className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm hover:border-zinc-700 transition-all group overflow-hidden">
                        <div className="aspect-square relative w-full bg-zinc-950">
                            ...
                            <div className="absolute bottom-4 left-4 z-10">
                                <h3 className="text-white font-bold uppercase tracking-wide text-lg">Barbeiro {i}</h3>
                        ...
                        <CardContent className="pt-4 space-y-3">
                            ...
                            <div className="flex gap-2">
                                <Button className="w-full h-8 text-xs uppercase tracking-wider bg-zinc-800 hover:bg-zinc-700 text-white border border-zinc-700 rounded-sm">
                                    Editar
                                </Button>
                            </div>
                        </CardContent>
