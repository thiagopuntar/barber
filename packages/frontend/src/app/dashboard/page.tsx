    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-card dark:bg-zinc-900/50 border-border dark:border-zinc-800 backdrop-blur-sm">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground dark:text-white tracking-tight">
              R$ 1.250,00
            </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="col-span-4 bg-card dark:bg-zinc-900/50 border-border dark:border-zinc-800 backdrop-blur-sm min-h-[300px]">
          <CardHeader>
            ...
            <p className="text-muted-foreground dark:text-zinc-300 text-xs uppercase tracking-wider">
          ...
          <CardContent>
            <div className="space-y-4">
              {BOOKINGS.slice(0, 5).map(booking => (
                <div
                  key={booking.id}
                  className="flex items-center justify-between border-b border-border dark:border-zinc-800 pb-2 last:border-0 last:pb-0"
                >
                  <div className="space-y-1">
                    <p className="text-sm font-bold text-foreground dark:text-white uppercase tracking-wide">
