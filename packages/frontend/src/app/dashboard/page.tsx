            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card className="bg-zinc-900/50 border-zinc-800 backdrop-blur-sm">
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <CardTitle className="text-sm font-medium uppercase tracking-wider text-zinc-300">
                            Faturamento Total
                        </CardTitle>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-zinc-300 mt-1 uppercase tracking-wide">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                <Card className="col-span-4 bg-zinc-900/50 border-zinc-800 backdrop-blur-sm min-h-[300px]">
                    <CardHeader>
                        ...
                        <p className="text-zinc-300 text-xs uppercase tracking-wider">Acompanhamento diário</p>
                    </CardHeader>
                    <CardContent className="flex items-center justify-center h-[200px] text-zinc-300 uppercase text-xs tracking-widest border border-dashed border-zinc-800 m-4 rounded-sm">
                ...
                <Card className="col-span-3 bg-zinc-900/50 border-zinc-800 backdrop-blur-sm min-h-[300px]">
                    <CardHeader>
                        ...
                        <p className="text-zinc-300 text-xs uppercase tracking-wider">Hoje</p>
                    </CardHeader>
                    <CardContent>
                            ...
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="flex items-center justify-between border-b border-zinc-800 pb-2 last:border-0 last:pb-0">
                                    <div className="space-y-1">
                                        ...
                                        <p className="text-xs text-zinc-300 uppercase tracking-widest">Corte + Barba</p>
                                    </div>
