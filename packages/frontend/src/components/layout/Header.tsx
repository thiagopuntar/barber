...
export function Header() {
    ...
    return (
        <header className="fixed top-0 right-0 z-30 flex h-16 w-full items-center justify-between border-b border-zinc-800 bg-zinc-950/80 px-4 shadow-sm backdrop-blur-md md:w-[calc(100%-16rem)] md:px-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <Button variant="ghost" size="icon" className="text-zinc-500 hover:text-zinc-300 hover:bg-zinc-900 rounded-sm">
                ...
                <div className="flex items-center gap-2 border-l border-zinc-800 pl-4">
                    ...
                    <div className="hidden text-right text-sm md:block">
                        ...
                        <p className="text-[10px] text-zinc-500 uppercase tracking-wider">admin@barber.com</p>
                    </div>
                    {/* Avatar do Usuário com Fallback */}
                    <Avatar className="h-8 w-8 border border-zinc-700">
                        <AvatarImage src="https://github.com/shadcn.png" alt="@shadcn" />
                        <AvatarFallback className="bg-zinc-800 text-zinc-400 text-xs">AD</AvatarFallback>
                    </Avatar>
                </div>
